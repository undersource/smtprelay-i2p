...
var (
	...
	proxyI2P	  = flag.String("proxy_i2p", "", "Outgoing I2P Proxy")
...
func ConfigLoad() {
	...
	if *remoteHost == "" && *command == "" && *proxyI2P == "" {
		log.Warn("no remote_host or command or proxy_i2p are set; mail will not be forwarded!")
	}
